...
//     QSGGeometry::Attribute::create(5, 1, QSGGeometry::IntType, false), // in_count

    QSGGeometry::Attribute::create(5, MaxPointsSize * 2, QSGGeometry::FloatType, false) // in_points
